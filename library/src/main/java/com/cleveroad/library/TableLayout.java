...
import static com.cleveroad.library.TableAdapter.ViewHolder;
...
//            invalidate();
    ...
    public TableLayout(Context context, AttributeSet attrs) {
        ...
        mShadowSize = getResources().getDimensionPixelSize(R.dimen.shadow_size);
...
//                    this.bringChildToFront(mDragHeaderViewHolder.getItemView());
//                    mDragHeaderViewHolder.getItemView().setLeft(x);
//                    for(ViewHolder vh : mDragViewHolders) {
//                        this.bringChildToFront(vh.getItemView());
//                        vh.getItemView().setLeft(x);
//                    }
//                    invalidate();
//                    for(List<ViewHolder> vhl : mBodyViewHolderTable) {
//                        for(ViewHolder vh : vhl) {
//                            vh.getItemView().invalidate();
//                        }
//                    }
...
//                mHeadViewHolder = makeAndSetup(FIXED_ROW_INDEX, FIXED_COLUMN_INDEX, 0, 0, mWidthCalc.getItem(0), mHeightCalc.getItem(0));
    ...
    private void shadowsVisibility() {
        ...
        for (int i = 0; i < mShadows.length; i++) {
            setAlpha(mShadows[i], Math.min(remainPixels[i] / (float) mShadowSize, 1));
        }
    }
